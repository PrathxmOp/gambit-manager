...
import app.gambit.manager.ui.viewmodel.installer.InstallerViewModel
import app.gambit.manager.ui.widgets.dialog.BackWarningDialog
import app.gambit.manager.ui.widgets.dialog.DownloadFailedDialog
import app.gambit.manager.ui.widgets.installer.StepGroupCard
...
class InstallerScreen(
    ...
    override fun Content() {
        ...
        val intentListener: (Intent) -> Unit = remember {
            {
                val msg = it.getStringExtra("gambit.extras.EXTRA_MESSAGE")
