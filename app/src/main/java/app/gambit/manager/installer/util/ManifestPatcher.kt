package app.gambit.manager.installer.util
...
object ManifestPatcher {
    ...
    private const val DISCORD_DRNE_PERMISSION = "com.chess.$DRNE_PERMISSION"
                        ...
                        return when (name) {
                            ...
                            "application" -> object : ReplaceAttrsVisitor(
                                ...
                                override fun end() {
                                    ...
                                    // Add StandaloneLichessActivity
                                    super.child(null, "activity").apply {
                                        attr(ANDROID_NAMESPACE, "name", android.R.attr.name, TYPE_STRING, "app.prathxm.chess.extension.lichesspuzzle.StandaloneLichessActivity")
                                        attr(ANDROID_NAMESPACE, "theme", android.R.attr.theme, TYPE_STRING, "@android:style/Theme.NoTitleBar")
                                        attr(ANDROID_NAMESPACE, "exported", android.R.attr.exported, TYPE_INT_BOOLEAN, 1)
                                        end()
                                    }

                                    // Add LichessPuzzleJourneyActivity
                                    super.child(null, "activity").apply {
                                        attr(ANDROID_NAMESPACE, "name", android.R.attr.name, TYPE_STRING, "app.prathxm.chess.extension.lichesspuzzle.LichessPuzzleJourneyActivity")
                                        attr(ANDROID_NAMESPACE, "theme", android.R.attr.theme, TYPE_STRING, "@android:style/Theme.NoTitleBar")
                                        attr(ANDROID_NAMESPACE, "exported", android.R.attr.exported, TYPE_INT_BOOLEAN, 1)
                                        end()
                                    }
