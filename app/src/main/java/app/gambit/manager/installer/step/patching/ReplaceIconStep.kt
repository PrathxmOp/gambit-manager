...
import app.gambit.manager.installer.utils.ArscUtil
import app.gambit.manager.installer.utils.ArscUtil.addColorResource
import app.gambit.manager.installer.utils.ArscUtil.getMainArscChunk
import app.gambit.manager.installer.utils.ArscUtil.getPackageChunk
import app.gambit.manager.installer.utils.ArscUtil.getResourceFileName
import app.gambit.manager.installer.utils.AxmlUtil
import app.gambit.manager.utils.DiscordVersion
import org.koin.core.component.inject

/**
 * Replaces the existing app icons with Gambit tinted ones
 */
